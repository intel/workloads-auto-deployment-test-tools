...
class LocalInstanceAdmin(ImportExportModelAdmin):
    ...
    search_fields = [field.name for field in LocalInstance._meta.fields]
...
class WorkloadSystemConfigAdmin(ImportExportModelAdmin):
    ...
    search_fields = [field.name for field in WorkloadSystemConfig._meta.fields]
...
class WorkloadComponentVersionAdmin(ImportExportModelAdmin):
    ...
    search_fields = [field.name for field in WorkloadComponentVersion._meta.fields]
